...
c
     ...
     &            (idup(i,1,iproc)*idup(j,1,iproc).lt.0).and.
     &            (mothup(1, i).eq.mothup(1, j)).and.
     &            (abs(idup(mothup(1, i),1,iproc)).eq.23)) 
...
c
     ...
     &           (idup(i,1,iproc)*idup(j,1,iproc).lt.0).and.
     &           (mothup(1, i).eq.mothup(1, j)).and.
     &           (abs(idup(mothup(1, i),1,iproc)).eq.23)) ! Leptons from same flavor but different charge
