...
class analysis_gg4m(analysis):
    ...
    def begin(self):
        ...
        self.mknewlf('mu0_pt', 'F')
        self.mknewlf('mu0_eta', 'F')
        self.mknewlf('mu0_phi', 'F')
        self.mknewlf('mu0_e', 'F')
        self.mknewlf('mu1_pt', 'F')
        self.mknewlf('mu1_eta', 'F')
        self.mknewlf('mu1_phi', 'F')
        self.mknewlf('mu1_e', 'F')
        self.mknewlf('mu2_pt', 'F')
        self.mknewlf('mu2_eta', 'F')
        self.mknewlf('mu2_phi', 'F')
        self.mknewlf('mu2_e', 'F')
        self.mknewlf('mu3_pt', 'F')
        self.mknewlf('mu3_eta', 'F')
        self.mknewlf('mu3_phi', 'F')
        self.mknewlf('mu3_e', 'F')
        self.mknewlf('inv_mass', 'F')
