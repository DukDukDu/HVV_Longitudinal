...
if 'mg' in sys.argv :
    mypub="/publicfs/cms/user/mingxuanzhang/gridpack/simulation_tool/mg5condor/{0}/diff_mass/{1}/{2}".format(sys.argv[1], sys.argv[2], sys.argv[3]) #this path is in ihep cluster
    rootfile = "/publicfs/cms/user/mingxuanzhang/gridpack/simulation_tool/mg5condor/sample/mc.019.2e2m_mh160_total/"
    
    #create lhe file path list
    file_list = []
    for i in range(100):
        file_list.append("{0}/{1}_mh{2}-0000{3:02d}".format(mypub, sys.argv[1], sys.argv[2], i))
    ...
    mypub="/publicfs/cms/user/mingxuanzhang/gridpack/simulation_tool/delpycondor/{0}/{1}/{2}".format(sys.argv[1], sys.argv[2], sys.argv[3])
    sample="/publicfs/cms/user/mingxuanzhang/gridpack/simulation_tool/delpycondor/sample/mc.{0}.{1}_{2}.showersimul".format(sys.argv[4], sys.argv[1], sys.argv[2])
